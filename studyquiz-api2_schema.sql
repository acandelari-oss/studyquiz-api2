...
\restrict x8YlVLfHswiTQkE8pjRig5oOJ2fwXuXNekHdSNnkVdz4d780IGEOwmomXth47fX
...
--
-- Name: learning_events; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: recall_answers; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.recall_answers OWNER TO postgres;

--
-- Name: topic_chunks; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.topic_chunks (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    topic_id uuid,
...
ALTER TABLE public.topic_chunks OWNER TO postgres;
...
--
-- Name: learning_events learning_events_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
ALTER TABLE ONLY public.quiz_attempts
    ADD CONSTRAINT quiz_attempts_pkey PRIMARY KEY (id, topic, quiz_id);
...
--
-- Name: quiz_attempts quiz_topic_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.quiz_attempts
    ADD CONSTRAINT quiz_topic_unique UNIQUE (id, topic, quiz_id);
...
--
-- Name: recall_answers recall_answers_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.recall_answers
    ADD CONSTRAINT recall_answers_pkey PRIMARY KEY (id);


--
-- Name: topic_chunks topic_chunks_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.topic_chunks
    ADD CONSTRAINT topic_chunks_pkey PRIMARY KEY (id);
...
--
-- Name: quiz_attempts_unique; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX quiz_attempts_unique ON public.quiz_attempts USING btree (project_id, quiz_id, question_index);


--
-- Name: unique_quiz_attempt; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX unique_quiz_attempt ON public.quiz_attempts USING btree (project_id, quiz_id, question_index);
...
--
-- Name: chunks chunks_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.chunks
    ADD CONSTRAINT chunks_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON DELETE CASCADE;
...
--
-- Name: quiz_attempts fk_project; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
ALTER TABLE ONLY public.quiz_answers
    ADD CONSTRAINT quiz_answers_quiz_id_fkey FOREIGN KEY (quiz_id) REFERENCES public.quizzes(id) ON DELETE CASCADE;
...
--
-- Name: topic_chunks topic_chunks_topic_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.topic_chunks
    ADD CONSTRAINT topic_chunks_topic_id_fkey FOREIGN KEY (topic_id) REFERENCES public.topics(id) ON DELETE CASCADE;
...
--
-- Name: topic_chunks; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.topic_chunks ENABLE ROW LEVEL SECURITY;
...
--
-- Name: TABLE flashcard_reviews; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE learning_events; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE recall_answers; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.recall_answers TO anon;
GRANT ALL ON TABLE public.recall_answers TO authenticated;
GRANT ALL ON TABLE public.recall_answers TO service_role;


--
-- Name: TABLE topic_chunks; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.topic_chunks TO anon;
GRANT ALL ON TABLE public.topic_chunks TO authenticated;
GRANT ALL ON TABLE public.topic_chunks TO service_role;
